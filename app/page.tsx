  ...
  return (
     <div>
      ...
      <TextTrans time="1000" text={
        ...
        <Card className="w-1/5 max-lg:w-1/2 m shadow-[0_10px_10px_0px_rgba(255,4,32,0.05)]" shadow="sm 0px" textAlign="center" minW="0" bg="black" border="1px" gap={0} borderColor="white-smoke">
        ...
        <Card className="w-1/5 max-lg:w-1/2 shadow-[0_10px_10px_0px_rgba(255,4,32,0.05)]" shadow="sm 0px" textAlign="center" minW="0" bg="black" border="1px" gap={0} borderColor="white-smoke">
          <Stack m="auto" p="6" spacing='2'>
