...
const Token = () => {
    ...
    <div id="token" className="m-auto w-full h-screen tracking-wide z-1 overflow-hidden">
        ...
        <div className="flex flex-col text-pretty justify-evenly text-white items-center z-40 h-full w-1/2 bg-[#FF0420] py-6 max-md:w-full rounded-lg">
        ...
        <p className="px-10 text-sm [text-shadow:_10px_10px_20px_rgb(0_0_0_/_70%)]">
